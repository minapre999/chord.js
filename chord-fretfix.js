 ...
 * along with this program.  If not, see <http://www.gnu.org/licenses/>.
 ...
 This fork updated by Peter Ferrett May 2021
 The original does not accept fret numbers over 10.  This has been rectified by
 passing the fret string as a comma delimited value.
 
 This means the positions much be passed as a comma delimited value.  However,
 higher fret numbers can be passed as position arguments
 
 e.g. 

 <chord name="CMaj7" positions="x,x,2,4,1,3" fingers="--2413" size="3" layout="1"></chord>
<chord name="CMaj7" positions="x,x,10,12,12,12" fingers="--1331" size="3" layout="1"></chord>
...
// updated by PF so chard is an array, not a string
        //Fields
        var _ctx;
    ...
    function GenerateChordHtml(name, positions, fingering, size, layout, stringNames) {
        ...
        if (posArray.length != 6 || fingering.length != 6) {
        ...
        var chordObj = ChordBoxImage(name, posArray, fingering, size, stringNames);
